...
class VoteResourceTest {
    ...
    void getSingleVotes(){
        ...
        given().auth().preemptive().basic(name, pw).when().get(path + "15")
                .then().statusCode(200).
        ...
        given().auth().preemptive().basic(name, pw).when().get(path + "39")
                .then().statusCode(200).
        ...
        given().auth().preemptive().basic(name, pw).when().get(path + "60")
                .then().statusCode(200).
